<?php
class newCarsController Extends BaseController{
	...
	function index(){
		...
		$this->layout->content 		= View::make('front.new_car.list',$view);
	}
	function detail($id){
		...
		$this->layout->menu 		= View::make('front.menu');
		$this->layout->content 		= View::make('front.new_car.detail',$view);
	}
