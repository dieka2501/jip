...
<section class="content">
  ...
  <div class="box box-default">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label>Name Category</label>
              {{Form::text('name',$name,array('class'=>'form-control','placeholder'=>'Input Category Name Here','required'=>'required'))}}
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            <div class="form-group">
                ...
                {{Form::select('parent',$arr_parent,$parent,array('class'=>'form-control'))}}
            </div>
          </div><!-- /.form-group -->
        </div><!-- /.col -->
      </div><!-- /.row -->
    ...
    <div class="box-footer">
      <a href="{{Config::get('app.url')}}public/admin/category" class="btn btn-warning">Back</a>
