...
@section('content')
<div class="jsi-bg">
<div class="lead text-center">SILHOUETTE IN THE SAND</div>
</div>
<section id="content">
	<div class="container">
		<div class="col-md-8 col-md-offset-2">
			<img src="<?php echo Config::get('app.url');?>aset/main/img/news-detail.jpg" class="img-responsive center-block">
			<br>
			<br>
